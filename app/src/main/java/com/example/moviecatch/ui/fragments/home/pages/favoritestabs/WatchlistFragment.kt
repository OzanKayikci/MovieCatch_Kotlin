...
@AndroidEntryPoint
class WatchlistFragment constructor(private val navController: NavController) : Fragment() {
    ...
    private fun observerFunctions() {
        ...
        favoritesViewModel.getWatchlistObservable().observe(
            viewLifecycleOwner
        ) { t ->
            if (t != null) {
    ...
    private fun fetchMovies() {
        CoroutineScope(Dispatchers.IO).launch {
            favoritesViewModel.getWatchlistMoviesFromDb()
        }
    }
